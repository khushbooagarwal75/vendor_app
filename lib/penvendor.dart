...
class PenVendor extends StatefulWidget {
  ...
  @override
  State<PenVendor> createState() => _PenVendorState();
}

class _PenVendorState extends State<PenVendor> {
  List<String> quant = ["Low", "Medium", "High"];
    String? selectedvalue;

  CollectionReference ref = FirebaseFirestore.instance.collection("Quantity");
                      ...
                      children: [
                        Padding(
                          ...
                          child: StreamBuilder<DocumentSnapshot>(
                            stream: FirebaseFirestore.instance.collection('Quantity').doc("pen").snapshots(),
                            builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                              ...
                              // Access the data
                              selectedvalue = snapshot.data?.get('product 1');
